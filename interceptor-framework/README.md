...
Restart the gateway with the new jar file on the classpath.  In this example, the new interceptor is in a jar file that can be found in the conductor-gateqy repository under `myNewInterceptor/target/proxy-1.0-SNAPSHOT.jar`.
